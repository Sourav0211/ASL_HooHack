...
VIDEO_FOLDER = os.path.join(os.getcwd(), 'data', 'sign_videos')  # Path to the videos folder
FINAL_PATH = os.path.join(os.getcwd(), 'final_path', 'matched_path.txt')  # Path to the matched_path.txt file
